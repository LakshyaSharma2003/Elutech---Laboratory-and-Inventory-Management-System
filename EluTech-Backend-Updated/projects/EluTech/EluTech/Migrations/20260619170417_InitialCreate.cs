        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Samples_Employees_AssignedEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    CurrentPhase = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequestedPhase = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestingRequests_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TestingRequests_Samples_SampleId",
                        column: x => x.SampleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Samples_AssignedEmployeeId",
                table: "Samples",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestingRequests_EmployeeId",
                table: "TestingRequests",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_TestingRequests_SampleId",
                table: "TestingRequests",
                column: "SampleId");
